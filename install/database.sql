...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2022 at 03:34 PM
...
(1, 'Super Admin', 'iamrakibhossen@gmail.com', 'admin', NULL, '6238276ac25d11647847274.png', '$2y$10$QyMGu.g6T425Vf0GwP5W6OK3FyWqyFFkTYa.8MveikdETQvhwTtQy', 'myNitvBUyktlzajYQEIiRIBrbW8ivBd7IpIw4Ww7kBmGO5OXpuUHsw11I1dg', NULL, '2022-04-26 03:49:44');
...
ALTER TABLE `deposits` ADD `plan_id` INT(10) UNSIGNED NOT NULL DEFAULT '0' AFTER `user_id`;
ALTER TABLE `general_settings` ADD `socialite_credentials` TEXT NULL DEFAULT NULL AFTER `ads_setting`;

UPDATE `general_settings` SET `socialite_credentials` = '{\"google\":{\"client_id\":\"--------------\",\"client_secret\":\"------------\",\"status\":1},\"facebook\":{\"client_id\":\"---------------\",\"client_secret\":\"----------------\",\"status\":1},\"linkedin\":{\"client_id\":\"--------------\",\"client_secret\":\"--------------\",\"status\":1}}';

ALTER TABLE `users` ADD `login_by` VARCHAR(255) NULL DEFAULT NULL AFTER `remember_token`;
